...
final Uri getBookingsApi = Uri.parse(baseUrl + 'booking_list');
final Uri acceptRejectApi = Uri.parse(baseUrl + 'update_booking_status');
final Uri addMoneyWalletApi = Uri.parse(baseUrl + 'add_wallet');
final Uri walletTransactionsApi = Uri.parse(baseUrl + 'restaurant_transaction');
